...
Senior Software Engineer from **Varna, Bulgaria** with a passion for crafting performant, type-safe web applications. I work across the full stack — from pixel-perfect frontends to robust backend architectures.

Currently focused on the modern **TypeScript ecosystem**, building with the latest frameworks and tooling. Background in **Laravel** and its ecosystem for battle-tested backend solutions.
